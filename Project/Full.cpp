...
{
	if (EditPoiskFull->Text == "Введите фамилию абитуриента") {
		EditPoiskFull->Text = "";
...
void __fastcall TFullForm::EditPoiskFullExit(TObject *Sender)
{
		...
		EditPoiskFull->Text = "Введите фамилию абитуриента";
...
if(ApplicantsForm->EditPoisk->Text!="" || ApplicantsForm->EditPoisk->Text!="Введите фамилию абитуриента")
{
...
DataSourceFull->DataSet = ADOQueryFull;
	...
	if (EditPoiskFull->Text=="Введите фамилию абитуриента" || EditPoiskFull->Text=="") {
		ButtonPoiskFull->Enabled=false;
	}
	else
	{
