...
void __fastcall TEditForm::KolMestEditMouseDown(TObject *Sender, TMouseButton Button,
          TShiftState Shift, int X, int Y)
{
	if (KolMestEdit->Text == "Введите количество мест") {
		KolMestEdit->Text = "";
...
{
	if (KolMestEdit->Text == "") {
		KolMestEdit->Text = "Введите количество мест";
		KolMestEdit->Font->Color = clBlack;
	}
}
//---------------------------------------------------------------------------
...
ComboBoxSpecialityKolMest->Text="Для специальности";
}
//---------------------------------------------------------------------------
...
if(ComboBoxSpecialityKolMest->ItemIndex==-1 || KolMestEdit->Text=="Введите количество мест"
