...
ApplicantsForm->Show();
	...
	if(ApplicantsForm->EditPoisk->Text!="¬ведите фамилию абитуриента")
	{
	ApplicantsForm->DataSourceApplicants->DataSet = ApplicantsForm->ADOQueryApplicants;
	...
	if(ApplicantsForm->EditPoiskKD->Text!="¬ведите фамилию абитуриента")
	{
	...
	if(ApplicantsForm->EditPoiskPed->Text!="¬ведите фамилию абитуриента")
	{
	...
	if(ApplicantsForm->EditPoiskEl->Text!="¬ведите фамилию абитуриента")
	{
...
ApplicantsForm->ADOQueryApplicants->First();
	...
	ApplicantsForm->EditPoisk->Text = "¬ведите фамилию абитуриента";
	ApplicantsForm->EditPoisk->Font->Color = clGray;


			if (ApplicantsForm->EditPoisk->Text=="¬ведите фамилию абитуриента" || ApplicantsForm->EditPoisk->Text=="") {
...
ShowMessage("јбитуриент был удален");
  */
...
ApplicantsForm->ADOQueryKD->Delete();
	...
	ApplicantsForm->EditPoiskKD->Text = "¬ведите фамилию абитуриента";
	ApplicantsForm->EditPoiskKD->Font->Color = clGray;


	if (ApplicantsForm->EditPoiskKD->Text=="¬ведите фамилию абитуриента" || ApplicantsForm->EditPoiskKD->Text=="") {
...
{
if(ApplicantsForm->DataSourcePed->DataSet == ApplicantsForm->ADOTablePed)
{
...
ApplicantsForm->ADOQueryPed->Delete();
	...
	ApplicantsForm->EditPoiskPed->Text = "¬ведите фамилию абитуриента";
	ApplicantsForm->EditPoiskPed->Font->Color = clGray;


			if (ApplicantsForm->EditPoiskPed->Text=="¬ведите фамилию абитуриента" || ApplicantsForm->EditPoiskPed->Text=="") {
...
{
if(ApplicantsForm->DataSourceEl->DataSet == ApplicantsForm->ADOTableEl)
{
...
ApplicantsForm->ADOQueryEl->Delete();
	...
	ApplicantsForm->EditPoiskEl->Text = "¬ведите фамилию абитуриента";
	ApplicantsForm->EditPoiskEl->Font->Color = clGray;


			if (ApplicantsForm->EditPoiskEl->Text=="¬ведите фамилию абитуриента" || ApplicantsForm->EditPoiskEl->Text=="") {
